...
): FirWhenExpressionImpl = FirWhenExpressionImpl(session, psi, subject, subjectVariable, calleeReference).apply {
...
fun FirTryExpression.copy(
    resultType: FirTypeRef = this.typeRef,
    calleeReference: FirReference = this.calleeReference
): FirTryExpressionImpl = FirTryExpressionImpl(session, psi, tryBlock, finallyBlock, calleeReference).apply {
