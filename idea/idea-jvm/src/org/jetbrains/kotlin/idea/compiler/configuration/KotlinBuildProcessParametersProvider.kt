...
class KotlinBuildProcessParametersProvider(project: Project) : BuildProcessParametersProvider() {
    private val compilerWorkspaceSettings = KotlinCompilerWorkspaceSettings.getInstance(project)
    private val kotlinPluginStartupComponent = PluginStartupComponent.getInstance()
